...
public class FileMenu extends EditorMenu {
	public FileMenu(final LevelEditor le, String name) {
		super(le, name);
		...
		LevelEditor.addAction("Save", new LevelEditor.Action() {
		...
		LevelEditor.addAction("Load", new LevelEditor.Action() {
			@Override
			public void run(String[] args) {
				// TODO Auto-generated method stub
				String path;
		...
		LevelEditor.addAction("New", new LevelEditor.Action() {
			@Override
			public void run(String[] args) {
